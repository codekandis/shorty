...
/**
 * Represents the base class of all wrapped `nullable resource` types.
 * @package codekandis/shorty
 * @author Christian Ramelow <info@codekandis.net>
 */
abstract class AbstractNullableResource extends AbstractObject implements NullableResourceInterface
{
	/**
	...
	/**
	 * Stores the value of the wrapped `nullable resource`.
	 * @var null|resource
	 */
	protected $value;
